  ...
  return (
    <div style={{ background: '#f9f9f9', padding: '20px', borderRadius: '4px', marginTop: '20px' }}>
      ...
      <div style={{ marginBottom: '15px' }}>
        <label style={{ display: 'block', marginBottom: '5px', fontWeight: '600' }}>Config Key</label>
        <input
          type="text"
          value={key}
          ...
          style={{ width: '100%', padding: '8px', border: '1px solid #ddd', borderRadius: '4px', fontFamily: 'monospace', background: initialConfig ? '#eee' : 'white', boxSizing: 'border-box' }}
        />
      </div>
      ...
      <div style={{ marginBottom: '15px' }}>
        ...
        <input
          ...
          style={{ width: '100%', padding: '8px', border: '1px solid #ddd', borderRadius: '4px', fontFamily: 'monospace', boxSizing: 'border-box' }}
        />
      </div>
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        <button
          ...
          disabled={saving}
          style={{ padding: '10px 20px', background: saving ? '#aaa' : '#28a745', color: 'white', border: 'none', borderRadius: '4px', cursor: saving ? 'not-allowed' : 'pointer' }}
        >
          {saving ? 'Saving...' : 'Save'}
        </button>
        <button
